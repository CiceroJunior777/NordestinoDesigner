  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "tailwind.config.jstext-muted-foreground tailwind.config.jsrounded-md tailwind.config.jsw-8 tailwind.config.jsfont-normal tailwind.config.jstext-[0.8rem]",
        row: "tailwind.config.jsflex tailwind.config.jsw-full tailwind.config.jsmt-2",
        cell: cn(
          "tailwind.config.jsrelative tailwind.config.jsp-0 tailwind.config.jstext-center tailwind.config.jstext-sm focus-within:tailwind.config.jsrelative focus-within:tailwind.config.jsz-20 [&:has([aria-selected])]:tailwind.config.jsbg-accent [&:has([aria-selected].day-outside)]:tailwind.config.jsbg-accent/50 [&:has([aria-selected].day-range-end)]:tailwind.config.jsrounded-r-md",
          props.mode === "range"
            ? "[&:has(>.day-range-end)]:tailwind.config.jsrounded-r-md [&:has(>.day-range-start)]:tailwind.config.jsrounded-l-md first:[&:has([aria-selected])]:tailwind.config.jsrounded-l-md last:[&:has([aria-selected])]:tailwind.config.jsrounded-r-md"
            : "[&:has([aria-selected])]:tailwind.config.jsrounded-md"
        ),
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "tailwind.config.jsh-8 tailwind.config.jsw-8 tailwind.config.jsp-0 tailwind.config.jsfont-normal aria-selected:tailwind.config.jsopacity-100"
        ),
        day_range_start: "tailwind.config.jsday-range-start",
        ...
        day_outside:
          "tailwind.config.jsday-outside tailwind.config.jstext-muted-foreground tailwind.config.jsopacity-50 tailwind.config.js aria-selected:tailwind.config.jsbg-accent/50 aria-selected:tailwind.config.jstext-muted-foreground aria-selected:tailwind.config.jsopacity-30",
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className="tailwind.config.jsh-4 tailwind.config.jsw-4" />,
        IconRight: ({ ...props }) => <ChevronRightIcon className="tailwind.config.jsh-4 tailwind.config.jsw-4" />,
      }}
      {...props}
    />
  )
