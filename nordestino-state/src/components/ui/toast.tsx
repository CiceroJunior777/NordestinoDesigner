...
const toastVariants = cva(
  "tailwind.config.jsgroup tailwind.config.jspointer-events-auto tailwind.config.jsrelative tailwind.config.jsflex tailwind.config.jsw-full tailwind.config.jsitems-center tailwind.config.jsjustify-between tailwind.config.jsspace-x-2 tailwind.config.jsoverflow-hidden tailwind.config.jsrounded-md tailwind.config.jsborder tailwind.config.jsp-4 tailwind.config.jspr-6 tailwind.config.jsshadow-lg tailwind.config.jstransition-all data-[swipe=cancel]:tailwind.config.jstranslate-x-0 data-[swipe=end]:tailwind.config.jstranslate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:tailwind.config.jstranslate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:tailwind.config.jstransition-none data-[state=open]:tailwind.config.jsanimate-in data-[state=closed]:tailwind.config.jsanimate-out data-[swipe=end]:tailwind.config.jsanimate-out data-[state=closed]:tailwind.config.jsfade-out-80 data-[state=closed]:tailwind.config.jsslide-out-to-right-full data-[state=open]:tailwind.config.jsslide-in-from-top-full data-[state=open]:sm:tailwind.config.jsslide-in-from-bottom-full",
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "tailwind.config.jsabsolute tailwind.config.jsright-1 tailwind.config.jstop-1 tailwind.config.jsrounded-md tailwind.config.jsp-1 tailwind.config.jstext-foreground/50 tailwind.config.jsopacity-0 tailwind.config.jstransition-opacity hover:tailwind.config.jstext-foreground focus:tailwind.config.jsopacity-100 focus:tailwind.config.jsoutline-none focus:tailwind.config.jsring-1 group-hover:tailwind.config.jsopacity-100 group-[.destructive]:tailwind.config.jstext-red-300 group-[.destructive]:hover:tailwind.config.jstext-red-50 group-[.destructive]:focus:tailwind.config.jsring-red-400 group-[.destructive]:focus:tailwind.config.jsring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("tailwind.config.jstext-sm tailwind.config.jsfont-semibold [&+div]:tailwind.config.jstext-xs", className)}
    {...props}
  />
))
